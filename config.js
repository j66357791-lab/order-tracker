...
export const CHANGELOG = [
  { ver: '1.5.0', date: '2026-09-16', notes: ['用户端「作品 · 能做什么」重做：左侧服务说明卡（矢量图标 + 卖点清单）+ 右侧主视觉大图 + 缩略图条，点缩略图 / 箭头 / 键盘切换，点大图看原图', '四个分类图标由表情符号换成内联 SVG 矢量图', '小沐AI 悬浮球改为伪 3D 球体（多层径向渐变 + 高光 + 底部内阴影），球内换成对话气泡图标', '悬浮球支持拖动：位置自动记忆、靠边自动吸附、双击复位，对话面板跟随球的位置展开'] },
